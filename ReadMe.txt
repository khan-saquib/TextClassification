...
4. I have implemented two algorithms. Naive Bayes and Logistic Regression. Filtering attributes + Logistic Regression takes almost an 
hour to execute. Hence, I have commented them. If you want to run Logistic Regression, do the following steps: 
